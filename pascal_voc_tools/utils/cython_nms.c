...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "pascal_voc_tools.utils.cython_nms"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pascal_voc_tools__utils__cython_nms
#define __PYX_HAVE_API__pascal_voc_tools__utils__cython_nms
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'pascal_voc_tools.utils.cython_nms' */
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_16pascal_voc_tools_5utils_10cython_nms_max(__pyx_t_5numpy_float32_t, __pyx_t_5numpy_float32_t); /*proto*/
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_16pascal_voc_tools_5utils_10cython_nms_min(__pyx_t_5numpy_float32_t, __pyx_t_5numpy_float32_t); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_int_t = { "int_t", NULL, sizeof(__pyx_t_5numpy_int_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5numpy_int_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5numpy_int_t), 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_float = { "float", NULL, sizeof(float), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "pascal_voc_tools.utils.cython_nms"
extern int __pyx_module_is_main_pascal_voc_tools__utils__cython_nms;
int __pyx_module_is_main_pascal_voc_tools__utils__cython_nms = 0;

/* Implementation of 'pascal_voc_tools.utils.cython_nms' */
...
static const char __pyx_k_pascal_voc_tools_utils_cython_nm[] = "pascal_voc_tools/utils/cython_nms.pyx";
static const char __pyx_k_Format_string_allocated_too_shor_2[] = "Format string allocated too short.";
static const char __pyx_k_pascal_voc_tools_utils_cython_nm_2[] = "pascal_voc_tools.utils.cython_nms";
...
static PyObject *__pyx_kp_s_pascal_voc_tools_utils_cython_nm;
static PyObject *__pyx_n_s_pascal_voc_tools_utils_cython_nm_2;
...
static PyObject *__pyx_pf_16pascal_voc_tools_5utils_10cython_nms_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, __pyx_t_5numpy_float32_t __pyx_v_thresh); /* proto */
static PyObject *__pyx_pf_16pascal_voc_tools_5utils_10cython_nms_2soft_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes_in, float __pyx_v_sigma, float __pyx_v_Nt, float __pyx_v_threshold, unsigned int __pyx_v_method); /* proto */
...
/* "pascal_voc_tools/utils/cython_nms.pyx":28
 * cimport numpy as np
 * 
...
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_16pascal_voc_tools_5utils_10cython_nms_max(__pyx_t_5numpy_float32_t __pyx_v_a, __pyx_t_5numpy_float32_t __pyx_v_b) {
  __pyx_t_5numpy_float32_t __pyx_r;
  __pyx_t_5numpy_float32_t __pyx_t_1;

  /* "pascal_voc_tools/utils/cython_nms.pyx":29
 * 
 * cdef inline np.float32_t max(np.float32_t a, np.float32_t b) nogil:
 *     return a if a >= b else b             # <<<<<<<<<<<<<<
 * 
...
/* "pascal_voc_tools/utils/cython_nms.pyx":31
 *     return a if a >= b else b
 * 
 * cdef inline np.float32_t min(np.float32_t a, np.float32_t b) nogil:             # <<<<<<<<<<<<<<
 *     return a if a <= b else b
...
static CYTHON_INLINE __pyx_t_5numpy_float32_t __pyx_f_16pascal_voc_tools_5utils_10cython_nms_min(__pyx_t_5numpy_float32_t __pyx_v_a, __pyx_t_5numpy_float32_t __pyx_v_b) {
  __pyx_t_5numpy_float32_t __pyx_r;
  __pyx_t_5numpy_float32_t __pyx_t_1;

  /* "pascal_voc_tools/utils/cython_nms.pyx":32
 * 
 * cdef inline np.float32_t min(np.float32_t a, np.float32_t b) nogil:
 *     return a if a <= b else b             # <<<<<<<<<<<<<<
 * 
...
/* "pascal_voc_tools/utils/cython_nms.pyx":37
...
/* Python wrapper */
static PyObject *__pyx_pw_16pascal_voc_tools_5utils_10cython_nms_1nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_16pascal_voc_tools_5utils_10cython_nms_1nms = {"nms", (PyCFunction)__pyx_pw_16pascal_voc_tools_5utils_10cython_nms_1nms, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_16pascal_voc_tools_5utils_10cython_nms_1nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pascal_voc_tools.utils.cython_nms.nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_16pascal_voc_tools_5utils_10cython_nms_nms(__pyx_self, __pyx_v_dets, __pyx_v_thresh);
...
static PyObject *__pyx_pf_16pascal_voc_tools_5utils_10cython_nms_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, __pyx_t_5numpy_float32_t __pyx_v_thresh) {
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":38
 * @cython.wraparound(False)
 * def nms(np.ndarray[np.float32_t, ndim=2] dets, np.float32_t thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":39
 * def nms(np.ndarray[np.float32_t, ndim=2] dets, np.float32_t thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":40
 *     cdef np.ndarray[np.float32_t, ndim=1] x1 = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":41
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":42
 *     cdef np.ndarray[np.float32_t, ndim=1] x2 = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] y2 = dets[:, 3]
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":44
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 4]
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":45
 * 
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = (x2 - x1 + 1) * (y2 - y1 + 1)
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":47
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]
 * 
 *     cdef int ndets = dets.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":49
 *     cdef int ndets = dets.shape[0]
 *     cdef np.ndarray[np.int_t, ndim=1] suppressed = \
 *             np.zeros((ndets), dtype=np.int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":62
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "pascal_voc_tools/utils/cython_nms.pyx":63
 * 
 *     with nogil:
 *       for _i in range(ndets):             # <<<<<<<<<<<<<<
 *           i = order[_i]
 ...
 */
        ...
        for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":64
 *     with nogil:
 *       for _i in range(ndets):
 *           i = order[_i]             # <<<<<<<<<<<<<<
 *           if suppressed[i] == 1:
 ...
 */
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":65
 *       for _i in range(ndets):
 *           i = order[_i]
 *           if suppressed[i] == 1:             # <<<<<<<<<<<<<<
 *               continue
 ...
 */
          ...
          if (__pyx_t_19) {
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":66
 *           i = order[_i]
 *           if suppressed[i] == 1:
 *               continue             # <<<<<<<<<<<<<<
 *           ix1 = x1[i]
 ...
 */
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":67
 *           if suppressed[i] == 1:
 *               continue
 *           ix1 = x1[i]             # <<<<<<<<<<<<<<
 *           iy1 = y1[i]
 ...
 */
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":68
 *               continue
 *           ix1 = x1[i]
 *           iy1 = y1[i]             # <<<<<<<<<<<<<<
 *           ix2 = x2[i]
 ...
 */
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":69
 *           ix1 = x1[i]
 *           iy1 = y1[i]
 *           ix2 = x2[i]             # <<<<<<<<<<<<<<
 *           iy2 = y2[i]
 ...
 */
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":70
 *           iy1 = y1[i]
 *           ix2 = x2[i]
 *           iy2 = y2[i]             # <<<<<<<<<<<<<<
 *           iarea = areas[i]
 ...
 */
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":71
 *           ix2 = x2[i]
 *           iy2 = y2[i]
 *           iarea = areas[i]             # <<<<<<<<<<<<<<
 *           for _j in range(_i + 1, ndets):
 ...
 */
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":72
 *           iy2 = y2[i]
 *           iarea = areas[i]
 *           for _j in range(_i + 1, ndets):             # <<<<<<<<<<<<<<
 *               j = order[_j]
 ...
 */
          ...
          for (__pyx_t_27 = (__pyx_v__i + 1); __pyx_t_27 < __pyx_t_26; __pyx_t_27+=1) {
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":73
 *           iarea = areas[i]
 *           for _j in range(_i + 1, ndets):
 *               j = order[_j]             # <<<<<<<<<<<<<<
 *               if suppressed[j] == 1:
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":74
 *           for _j in range(_i + 1, ndets):
 *               j = order[_j]
 *               if suppressed[j] == 1:             # <<<<<<<<<<<<<<
 *                   continue
 ...
 */
            ...
            if (__pyx_t_19) {
              ...
              /* "pascal_voc_tools/utils/cython_nms.pyx":75
 *               j = order[_j]
 *               if suppressed[j] == 1:
 *                   continue             # <<<<<<<<<<<<<<
 *               xx1 = max(ix1, x1[j])
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":76
 *               if suppressed[j] == 1:
 *                   continue
 *               xx1 = max(ix1, x1[j])             # <<<<<<<<<<<<<<
 *               yy1 = max(iy1, y1[j])
 ...
 */
            ...
            __pyx_v_xx1 = __pyx_f_16pascal_voc_tools_5utils_10cython_nms_max(__pyx_v_ix1, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x1.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_x1.diminfo[0].strides)));

            /* "pascal_voc_tools/utils/cython_nms.pyx":77
 *                   continue
 *               xx1 = max(ix1, x1[j])
 *               yy1 = max(iy1, y1[j])             # <<<<<<<<<<<<<<
 *               xx2 = min(ix2, x2[j])
 ...
 */
            ...
            __pyx_v_yy1 = __pyx_f_16pascal_voc_tools_5utils_10cython_nms_max(__pyx_v_iy1, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y1.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_y1.diminfo[0].strides)));

            /* "pascal_voc_tools/utils/cython_nms.pyx":78
 *               xx1 = max(ix1, x1[j])
 *               yy1 = max(iy1, y1[j])
 *               xx2 = min(ix2, x2[j])             # <<<<<<<<<<<<<<
 *               yy2 = min(iy2, y2[j])
 ...
 */
            ...
            __pyx_v_xx2 = __pyx_f_16pascal_voc_tools_5utils_10cython_nms_min(__pyx_v_ix2, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x2.rcbuffer->pybuffer.buf, __pyx_t_32, __pyx_pybuffernd_x2.diminfo[0].strides)));

            /* "pascal_voc_tools/utils/cython_nms.pyx":79
 *               yy1 = max(iy1, y1[j])
 *               xx2 = min(ix2, x2[j])
 *               yy2 = min(iy2, y2[j])             # <<<<<<<<<<<<<<
 *               w = max(0.0, xx2 - xx1 + 1)
 ...
 */
            ...
            __pyx_v_yy2 = __pyx_f_16pascal_voc_tools_5utils_10cython_nms_min(__pyx_v_iy2, (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y2.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_y2.diminfo[0].strides)));

            /* "pascal_voc_tools/utils/cython_nms.pyx":80
 *               xx2 = min(ix2, x2[j])
 *               yy2 = min(iy2, y2[j])
 *               w = max(0.0, xx2 - xx1 + 1)             # <<<<<<<<<<<<<<
 *               h = max(0.0, yy2 - yy1 + 1)
 *               inter = w * h
 */
            __pyx_v_w = __pyx_f_16pascal_voc_tools_5utils_10cython_nms_max(0.0, ((__pyx_v_xx2 - __pyx_v_xx1) + 1.0));

            /* "pascal_voc_tools/utils/cython_nms.pyx":81
 *               yy2 = min(iy2, y2[j])
 *               w = max(0.0, xx2 - xx1 + 1)
 *               h = max(0.0, yy2 - yy1 + 1)             # <<<<<<<<<<<<<<
 *               inter = w * h
 ...
 */
            __pyx_v_h = __pyx_f_16pascal_voc_tools_5utils_10cython_nms_max(0.0, ((__pyx_v_yy2 - __pyx_v_yy1) + 1.0));

            /* "pascal_voc_tools/utils/cython_nms.pyx":82
 *               w = max(0.0, xx2 - xx1 + 1)
 *               h = max(0.0, yy2 - yy1 + 1)
 *               inter = w * h             # <<<<<<<<<<<<<<
 *               ovr = inter / (iarea + areas[j] - inter)
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":83
 *               h = max(0.0, yy2 - yy1 + 1)
 *               inter = w * h
 *               ovr = inter / (iarea + areas[j] - inter)             # <<<<<<<<<<<<<<
 *               if ovr >= thresh:
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":84
 *               inter = w * h
 *               ovr = inter / (iarea + areas[j] - inter)
 *               if ovr >= thresh:             # <<<<<<<<<<<<<<
 *                   suppressed[j] = 1
 ...
 */
            ...
            if (__pyx_t_19) {
              ...
              /* "pascal_voc_tools/utils/cython_nms.pyx":85
 *               ovr = inter / (iarea + areas[j] - inter)
 *               if ovr >= thresh:
 *                   suppressed[j] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":87
 *                   suppressed[j] = 1
 * 
 *     return np.where(suppressed == 0)[0]             # <<<<<<<<<<<<<<
 * 
...
/* "pascal_voc_tools/utils/cython_nms.pyx":98
 * @cython.cdivision(True)
 * @cython.wraparound(False)
 * def soft_nms(             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_16pascal_voc_tools_5utils_10cython_nms_3soft_nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_16pascal_voc_tools_5utils_10cython_nms_3soft_nms = {"soft_nms", (PyCFunction)__pyx_pw_16pascal_voc_tools_5utils_10cython_nms_3soft_nms, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_16pascal_voc_tools_5utils_10cython_nms_3soft_nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pascal_voc_tools.utils.cython_nms.soft_nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  ...
  __pyx_r = __pyx_pf_16pascal_voc_tools_5utils_10cython_nms_2soft_nms(__pyx_self, __pyx_v_boxes_in, __pyx_v_sigma, __pyx_v_Nt, __pyx_v_threshold, __pyx_v_method);
...
static PyObject *__pyx_pf_16pascal_voc_tools_5utils_10cython_nms_2soft_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes_in, float __pyx_v_sigma, float __pyx_v_Nt, float __pyx_v_threshold, unsigned int __pyx_v_method) {
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":105
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":106
 * ):
 *     boxes = boxes_in.copy()
 *     cdef unsigned int N = boxes.shape[0]             # <<<<<<<<<<<<<<
 *     cdef float iw, ih, box_area
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":109
 *     cdef float iw, ih, box_area
 *     cdef float ua
 *     cdef int pos = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":110
 *     cdef float ua
 *     cdef int pos = 0
 *     cdef float maxscore = 0             # <<<<<<<<<<<<<<
 *     cdef int maxpos = 0
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":111
 *     cdef int pos = 0
 *     cdef float maxscore = 0
 *     cdef int maxpos = 0             # <<<<<<<<<<<<<<
 *     cdef float x1, x2, y1, y2, tx1, tx2, ty1, ty2, ts, area, weight, ov
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":113
 *     cdef int maxpos = 0
 *     cdef float x1, x2, y1, y2, tx1, tx2, ty1, ty2, ts, area, weight, ov
 *     inds = np.arange(N)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":115
 *     inds = np.arange(N)
 * 
 *     for i in range(N):             # <<<<<<<<<<<<<<
 *         maxscore = boxes[i, 4]
 ...
 */
  ...
  for (;;) {
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":116
 * 
 *     for i in range(N):
 *         maxscore = boxes[i, 4]             # <<<<<<<<<<<<<<
 *         maxpos = i
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":117
 *     for i in range(N):
 *         maxscore = boxes[i, 4]
 *         maxpos = i             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":119
 *         maxpos = i
 * 
 *         tx1 = boxes[i,0]             # <<<<<<<<<<<<<<
 *         ty1 = boxes[i,1]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":120
 * 
 *         tx1 = boxes[i,0]
 *         ty1 = boxes[i,1]             # <<<<<<<<<<<<<<
 *         tx2 = boxes[i,2]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":121
 *         tx1 = boxes[i,0]
 *         ty1 = boxes[i,1]
 *         tx2 = boxes[i,2]             # <<<<<<<<<<<<<<
 *         ty2 = boxes[i,3]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":122
 *         ty1 = boxes[i,1]
 *         tx2 = boxes[i,2]
 *         ty2 = boxes[i,3]             # <<<<<<<<<<<<<<
 *         ts = boxes[i,4]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":123
 *         tx2 = boxes[i,2]
 *         ty2 = boxes[i,3]
 *         ts = boxes[i,4]             # <<<<<<<<<<<<<<
 *         ti = inds[i]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":124
 *         ty2 = boxes[i,3]
 *         ts = boxes[i,4]
 *         ti = inds[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":126
 *         ti = inds[i]
 * 
 *         pos = i + 1             # <<<<<<<<<<<<<<
 *         # get max box
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":128
 *         pos = i + 1
 *         # get max box
 *         while pos < N:             # <<<<<<<<<<<<<<
 ...
 */
    while (1) {
      ...
      /* "pascal_voc_tools/utils/cython_nms.pyx":129
 *         # get max box
 *         while pos < N:
 *             if maxscore < boxes[pos, 4]:             # <<<<<<<<<<<<<<
 *                 maxscore = boxes[pos, 4]
 ...
 */
      ...
      if (__pyx_t_11) {
        ...
        /* "pascal_voc_tools/utils/cython_nms.pyx":130
 *         while pos < N:
 *             if maxscore < boxes[pos, 4]:
 *                 maxscore = boxes[pos, 4]             # <<<<<<<<<<<<<<
 *                 maxpos = pos
 ...
 */
        ...
        /* "pascal_voc_tools/utils/cython_nms.pyx":131
 *             if maxscore < boxes[pos, 4]:
 *                 maxscore = boxes[pos, 4]
 *                 maxpos = pos             # <<<<<<<<<<<<<<
 *             pos = pos + 1
 ...
 */
      ...
      /* "pascal_voc_tools/utils/cython_nms.pyx":132
 *                 maxscore = boxes[pos, 4]
 *                 maxpos = pos
 *             pos = pos + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":135
 * 
 *         # add max box as a detection
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":136
 *         # add max box as a detection
 *         boxes[i,0] = boxes[maxpos,0]
 *         boxes[i,1] = boxes[maxpos,1]             # <<<<<<<<<<<<<<
 *         boxes[i,2] = boxes[maxpos,2]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":137
 *         boxes[i,0] = boxes[maxpos,0]
 *         boxes[i,1] = boxes[maxpos,1]
 *         boxes[i,2] = boxes[maxpos,2]             # <<<<<<<<<<<<<<
 *         boxes[i,3] = boxes[maxpos,3]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":138
 *         boxes[i,1] = boxes[maxpos,1]
 *         boxes[i,2] = boxes[maxpos,2]
 *         boxes[i,3] = boxes[maxpos,3]             # <<<<<<<<<<<<<<
 *         boxes[i,4] = boxes[maxpos,4]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":139
 *         boxes[i,2] = boxes[maxpos,2]
 *         boxes[i,3] = boxes[maxpos,3]
 *         boxes[i,4] = boxes[maxpos,4]             # <<<<<<<<<<<<<<
 *         inds[i] = inds[maxpos]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":140
 *         boxes[i,3] = boxes[maxpos,3]
 *         boxes[i,4] = boxes[maxpos,4]
 *         inds[i] = inds[maxpos]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":143
 * 
 *         # swap ith box with position of max box
 *         boxes[maxpos,0] = tx1             # <<<<<<<<<<<<<<
 *         boxes[maxpos,1] = ty1
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":144
 *         # swap ith box with position of max box
 *         boxes[maxpos,0] = tx1
 *         boxes[maxpos,1] = ty1             # <<<<<<<<<<<<<<
 *         boxes[maxpos,2] = tx2
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":145
 *         boxes[maxpos,0] = tx1
 *         boxes[maxpos,1] = ty1
 *         boxes[maxpos,2] = tx2             # <<<<<<<<<<<<<<
 *         boxes[maxpos,3] = ty2
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":146
 *         boxes[maxpos,1] = ty1
 *         boxes[maxpos,2] = tx2
 *         boxes[maxpos,3] = ty2             # <<<<<<<<<<<<<<
 *         boxes[maxpos,4] = ts
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":147
 *         boxes[maxpos,2] = tx2
 *         boxes[maxpos,3] = ty2
 *         boxes[maxpos,4] = ts             # <<<<<<<<<<<<<<
 *         inds[maxpos] = ti
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":148
 *         boxes[maxpos,3] = ty2
 *         boxes[maxpos,4] = ts
 *         inds[maxpos] = ti             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":150
 *         inds[maxpos] = ti
 * 
 *         tx1 = boxes[i,0]             # <<<<<<<<<<<<<<
 *         ty1 = boxes[i,1]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":151
 * 
 *         tx1 = boxes[i,0]
 *         ty1 = boxes[i,1]             # <<<<<<<<<<<<<<
 *         tx2 = boxes[i,2]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":152
 *         tx1 = boxes[i,0]
 *         ty1 = boxes[i,1]
 *         tx2 = boxes[i,2]             # <<<<<<<<<<<<<<
 *         ty2 = boxes[i,3]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":153
 *         ty1 = boxes[i,1]
 *         tx2 = boxes[i,2]
 *         ty2 = boxes[i,3]             # <<<<<<<<<<<<<<
 *         ts = boxes[i,4]
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":154
 *         tx2 = boxes[i,2]
 *         ty2 = boxes[i,3]
 *         ts = boxes[i,4]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":156
 *         ts = boxes[i,4]
 * 
 *         pos = i + 1             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "pascal_voc_tools/utils/cython_nms.pyx":159
 *         # NMS iterations, note that N changes if detection boxes fall below
 *         # threshold
 *         while pos < N:             # <<<<<<<<<<<<<<
 *             x1 = boxes[pos, 0]
 ...
 */
    while (1) {
      ...
      /* "pascal_voc_tools/utils/cython_nms.pyx":160
 *         # threshold
 *         while pos < N:
 *             x1 = boxes[pos, 0]             # <<<<<<<<<<<<<<
 *             y1 = boxes[pos, 1]
 ...
 */
      ...
      /* "pascal_voc_tools/utils/cython_nms.pyx":161
 *         while pos < N:
 *             x1 = boxes[pos, 0]
 *             y1 = boxes[pos, 1]             # <<<<<<<<<<<<<<
 *             x2 = boxes[pos, 2]
 ...
 */
      ...
      /* "pascal_voc_tools/utils/cython_nms.pyx":162
 *             x1 = boxes[pos, 0]
 *             y1 = boxes[pos, 1]
 *             x2 = boxes[pos, 2]             # <<<<<<<<<<<<<<
 *             y2 = boxes[pos, 3]
 ...
 */
      ...
      /* "pascal_voc_tools/utils/cython_nms.pyx":163
 *             y1 = boxes[pos, 1]
 *             x2 = boxes[pos, 2]
 *             y2 = boxes[pos, 3]             # <<<<<<<<<<<<<<
 *             s = boxes[pos, 4]
 ...
 */
      ...
      /* "pascal_voc_tools/utils/cython_nms.pyx":164
 *             x2 = boxes[pos, 2]
 *             y2 = boxes[pos, 3]
 *             s = boxes[pos, 4]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "pascal_voc_tools/utils/cython_nms.pyx":166
 *             s = boxes[pos, 4]
 * 
 *             area = (x2 - x1 + 1) * (y2 - y1 + 1)             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "pascal_voc_tools/utils/cython_nms.pyx":167
 * 
 *             area = (x2 - x1 + 1) * (y2 - y1 + 1)
 *             iw = (min(tx2, x2) - max(tx1, x1) + 1)             # <<<<<<<<<<<<<<
 *             if iw > 0:
 ...
 */
      __pyx_v_iw = ((__pyx_f_16pascal_voc_tools_5utils_10cython_nms_min(__pyx_v_tx2, __pyx_v_x2) - __pyx_f_16pascal_voc_tools_5utils_10cython_nms_max(__pyx_v_tx1, __pyx_v_x1)) + 1.0);

      /* "pascal_voc_tools/utils/cython_nms.pyx":168
 *             area = (x2 - x1 + 1) * (y2 - y1 + 1)
 *             iw = (min(tx2, x2) - max(tx1, x1) + 1)
 *             if iw > 0:             # <<<<<<<<<<<<<<
 *                 ih = (min(ty2, y2) - max(ty1, y1) + 1)
 ...
 */
      ...
      if (__pyx_t_11) {
        ...
        /* "pascal_voc_tools/utils/cython_nms.pyx":169
 *             iw = (min(tx2, x2) - max(tx1, x1) + 1)
 *             if iw > 0:
 *                 ih = (min(ty2, y2) - max(ty1, y1) + 1)             # <<<<<<<<<<<<<<
 *                 if ih > 0:
 ...
 */
        __pyx_v_ih = ((__pyx_f_16pascal_voc_tools_5utils_10cython_nms_min(__pyx_v_ty2, __pyx_v_y2) - __pyx_f_16pascal_voc_tools_5utils_10cython_nms_max(__pyx_v_ty1, __pyx_v_y1)) + 1.0);

        /* "pascal_voc_tools/utils/cython_nms.pyx":170
 *             if iw > 0:
 *                 ih = (min(ty2, y2) - max(ty1, y1) + 1)
 *                 if ih > 0:             # <<<<<<<<<<<<<<
 *                     ua = float((tx2 - tx1 + 1) * (ty2 - ty1 + 1) + area - iw * ih)
 ...
 */
        ...
        if (__pyx_t_11) {
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":171
 *                 ih = (min(ty2, y2) - max(ty1, y1) + 1)
 *                 if ih > 0:
 *                     ua = float((tx2 - tx1 + 1) * (ty2 - ty1 + 1) + area - iw * ih)             # <<<<<<<<<<<<<<
 *                     ov = iw * ih / ua #iou between max box and detection box
 ...
 */
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":172
 *                 if ih > 0:
 *                     ua = float((tx2 - tx1 + 1) * (ty2 - ty1 + 1) + area - iw * ih)
 *                     ov = iw * ih / ua #iou between max box and detection box             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":174
 *                     ov = iw * ih / ua #iou between max box and detection box
 * 
 *                     if method == 1: # linear             # <<<<<<<<<<<<<<
 *                         if ov > Nt:
 ...
 */
          switch (__pyx_v_method) {
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":175
 * 
 *                     if method == 1: # linear
 *                         if ov > Nt:             # <<<<<<<<<<<<<<
 *                             weight = 1 - ov
 ...
 */
            ...
            if (__pyx_t_11) {
              ...
              /* "pascal_voc_tools/utils/cython_nms.pyx":176
 *                     if method == 1: # linear
 *                         if ov > Nt:
 *                             weight = 1 - ov             # <<<<<<<<<<<<<<
 *                         else:
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":178
 *                             weight = 1 - ov
 *                         else:
 *                             weight = 1             # <<<<<<<<<<<<<<
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":179
 *                         else:
 *                             weight = 1
 *                     elif method == 2: # gaussian             # <<<<<<<<<<<<<<
 *                         weight = np.exp(-(ov * ov)/sigma)
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":180
 *                             weight = 1
 *                     elif method == 2: # gaussian
 *                         weight = np.exp(-(ov * ov)/sigma)             # <<<<<<<<<<<<<<
 *                     else: # original NMS
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":182
 *                         weight = np.exp(-(ov * ov)/sigma)
 *                     else: # original NMS
 *                         if ov > Nt:             # <<<<<<<<<<<<<<
 *                             weight = 0
 ...
 */
            ...
            if (__pyx_t_11) {
              ...
              /* "pascal_voc_tools/utils/cython_nms.pyx":183
 *                     else: # original NMS
 *                         if ov > Nt:
 *                             weight = 0             # <<<<<<<<<<<<<<
 *                         else:
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":185
 *                             weight = 0
 *                         else:
 *                             weight = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":187
 *                             weight = 1
 * 
 *                     boxes[pos, 4] = weight*boxes[pos, 4]             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "pascal_voc_tools/utils/cython_nms.pyx":191
 *                     # if box score falls below threshold, discard the box by
 ...
 */
          ...
          if (__pyx_t_11) {
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":192
 *                     # swapping with last box update N
 *                     if boxes[pos, 4] < threshold:
 *                         boxes[pos,0] = boxes[N-1, 0]             # <<<<<<<<<<<<<<
 *                         boxes[pos,1] = boxes[N-1, 1]
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":193
 *                     if boxes[pos, 4] < threshold:
 *                         boxes[pos,0] = boxes[N-1, 0]
 *                         boxes[pos,1] = boxes[N-1, 1]             # <<<<<<<<<<<<<<
 *                         boxes[pos,2] = boxes[N-1, 2]
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":194
 *                         boxes[pos,0] = boxes[N-1, 0]
 *                         boxes[pos,1] = boxes[N-1, 1]
 *                         boxes[pos,2] = boxes[N-1, 2]             # <<<<<<<<<<<<<<
 *                         boxes[pos,3] = boxes[N-1, 3]
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":195
 *                         boxes[pos,1] = boxes[N-1, 1]
 *                         boxes[pos,2] = boxes[N-1, 2]
 *                         boxes[pos,3] = boxes[N-1, 3]             # <<<<<<<<<<<<<<
 *                         boxes[pos,4] = boxes[N-1, 4]
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":196
 *                         boxes[pos,2] = boxes[N-1, 2]
 *                         boxes[pos,3] = boxes[N-1, 3]
 *                         boxes[pos,4] = boxes[N-1, 4]             # <<<<<<<<<<<<<<
 *                         inds[pos] = inds[N-1]
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":197
 *                         boxes[pos,3] = boxes[N-1, 3]
 *                         boxes[pos,4] = boxes[N-1, 4]
 *                         inds[pos] = inds[N-1]             # <<<<<<<<<<<<<<
 *                         N = N - 1
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":198
 *                         boxes[pos,4] = boxes[N-1, 4]
 *                         inds[pos] = inds[N-1]
 *                         N = N - 1             # <<<<<<<<<<<<<<
 *                         pos = pos - 1
 ...
 */
            ...
            /* "pascal_voc_tools/utils/cython_nms.pyx":199
 *                         inds[pos] = inds[N-1]
 *                         N = N - 1
 *                         pos = pos - 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "pascal_voc_tools/utils/cython_nms.pyx":201
 *                         pos = pos - 1
 * 
 *             pos = pos + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":203
 *             pos = pos + 1
 * 
 *     return boxes[:N], inds[:N]             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_pascal_voc_tools_utils_cython_nm, __pyx_k_pascal_voc_tools_utils_cython_nm, sizeof(__pyx_k_pascal_voc_tools_utils_cython_nm), 0, 0, 1, 0},
  {&__pyx_n_s_pascal_voc_tools_utils_cython_nm_2, __pyx_k_pascal_voc_tools_utils_cython_nm_2, sizeof(__pyx_k_pascal_voc_tools_utils_cython_nm_2), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(2, 0, 28, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pascal_voc_tools_utils_cython_nm, __pyx_n_s_nms, 37, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 37, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pascal_voc_tools__utils__cython_nms) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pascal_voc_tools.utils.cython_nms")) {
      if (unlikely(PyDict_SetItemString(modules, "pascal_voc_tools.utils.cython_nms", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pascal_voc_tools/utils/cython_nms.pyx":25
 * 
 * cimport cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] y1 = dets[:, 1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_16pascal_voc_tools_5utils_10cython_nms_1nms, NULL, __pyx_n_s_pascal_voc_tools_utils_cython_nm_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     float sigma=0.5,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_16pascal_voc_tools_5utils_10cython_nms_3soft_nms, NULL, __pyx_n_s_pascal_voc_tools_utils_cython_nm_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 98, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_soft_nms, __pyx_t_1) < 0) __PYX_ERR(0, 98, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pascal_voc_tools/utils/cython_nms.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pascal_voc_tools.utils.cython_nms", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pascal_voc_tools.utils.cython_nms");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
